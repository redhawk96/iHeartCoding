   ...
   <!-- END wrapper -->
   <!-- jQuery  -->
   <script src="/iHeartCoding/public/admin/assets/js/jquery.min.js"></script>
   <script src="/iHeartCoding/public/admin/assets/js/bootstrap.bundle.min.js"></script>
   <script src="/iHeartCoding/public/admin/assets/js/metisMenu.min.js"></script>
   ...
   <script src="/iHeartCoding/public/admin/plugins/datatables/jszip.min.js"></script>
   <script src="/iHeartCoding/public/admin/plugins/datatables/pdfmake.min.js"></script>
   <script src="/iHeartCoding/public/admin/plugins/datatables/vfs_fonts.js"></script>
   ...
   <!-- App js -->
   <script src="/iHeartCoding/public/admin/assets/js/app.js"></script>
</body>
</html>