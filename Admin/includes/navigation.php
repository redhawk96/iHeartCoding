<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
    ...
    <div class="navbar-header">
        ...
        <a class="navbar-brand" href="/iHeartCoding/Admin/">I <i class="fa fa-code"></i> Coding</a>
    </div>
    <!-- Top Menu Items -->
    <ul class="nav navbar-right top-nav">
        ...
        <li class="dropdown">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-user" style="padding-right:10px;"></i> <?php echo $_SESSION['username']; ?> <b class="caret"></b></a>
    ...
    <div class="collapse navbar-collapse navbar-ex1-collapse">
        <ul class="nav navbar-nav side-nav">
            <li>
                <a href="/iHeartCoding/Admin/"><i class="fa fa-fw fa-dashboard"></i> Dashboard</a>
            </li>
            <li>
